...
class Day_23 {
    public static void main(String[] args) throws Exception {
        log(Day_23.class.getName());
        final String input = loadTextFile(Day_23.class, "input.txt");
        List<String> rawCups = splitString(input, "");
        ...
        log("Part 2: " + ((long)number1Node.getValue() * (long)number2Node.getValue()));
    }
